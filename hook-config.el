...
(defun magit-revision-hook-function ()
  ...
  (define-key magit-revision-mode-map (kbd "/") 'search-forward)
  (define-key magit-revision-mode-map (kbd "0") 'beginning-of-line)
  (define-key magit-revision-mode-map (kbd "*") 'evil-search-word-forward)
  (define-key magit-revision-mode-map (kbd "#") 'evil-search-word-backward)
  ...
  (define-key magit-revision-mode-map (kbd "w") 'forward-word)
  (define-key magit-revision-mode-map (kbd "b") 'backward-word)
