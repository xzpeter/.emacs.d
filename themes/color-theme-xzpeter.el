(defun color-theme-xzpeter-dark ()
  "Dark Color theme by xzpeter"
  (interactive)
  (color-theme-install
   '(color-theme-ld-dark
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "gold2" :weight bold :height 1.2 :family "Monaco"))))
     ...
     ;; (font-lock-type-face ((t (:bold t :foreground "PaleGreen" :weight bold :height 1.05 :family "Verdana"))))
